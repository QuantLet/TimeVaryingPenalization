...
moving window, time-series, estimation, L1-norm, error, beta, multi-dimensional, multivariate normal'

See also : 'TVPvariance, TVPdesign, MVAgrouplasso, MVAlassocontour, MVAlassoregress, SMSlassocar, SMSlassoridge, quantilelasso'
